...
public class UIFragment_two extends Fragment implements View.OnClickListener{
    ...
    btnDivide,btnMultiply,btnClear,btnEquals,btnPoint,btnBracketOpen,btnBracketClose,
    btnSin,btnCos,btnTan,btnLog,btnSqrt,btnExponential,btnPermutation,btnPie,btnLn,btnPower;
    ...
    Button[] mButtons = {btn0,btn1,btn2,btn3,btn4,btn5,btn6,btn7,btn8,btn9,btnMinus,btnPlus,
     ...
     int[] mButtonsIDs = {R.id.btn0_2,R.id.btn1_2,R.id.btn2_2,R.id.btn3_2,R.id.btn4_2,R.id.btn5_2,R.id.btn6_2,R.id.btn7_2,R.id.btn8_2,
             R.id.btn9_2,R.id.btnMinus2,R.id.btnPlus2,R.id.btnDivide2,R.id.btnMultiply2,R.id.btnClear2,R.id.btnEquals2,R.id.btnPoint2,
             R.id.btnBracket_open,R.id.btnBracket_close, R.id.btnSin,R.id.btnCos,R.id.btnTan,R.id.btnLog,R.id.btnSquareRoot,
